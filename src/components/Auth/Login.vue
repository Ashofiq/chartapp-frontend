            ...
            <form action="./" method="get" autocomplete="off" novalidate>
              ...
              <div class="mb-2">
                ...
                <div class="input-group input-group-flat">
                  <input type="password" class="form-control" v-model="password"  placeholder="Your password"  autocomplete="off">
              ...
              <div class="form-footer">
                <button type="submit" @click.prevent="submit()" class="btn btn-primary w-100">Sign in</button>
              </div>
            </form>
          </div>
        ...
        submit(){
            this.$validate().then((res) => {
                ...
                if (res) {
                    ...
                    axios.post(process.env.VUE_APP_BASE_URL+'/login', {email:this.email, password: this.password})
                        .then(res => {
                            if (res.status == 201) {
